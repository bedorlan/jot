const callsLimit = Math.pow(10, 6)
let callsCounter = 0
function newCall() {
...
searchNumber = function (n) {
  const population = createPopulation(500, 128)
...
const ski100 =
  'I I(  S KSS ( SS())KS   K)(S I((  I(    KSS (ISS()) KS)K)) ( (II )    ()I(( ) SSKSS)( SS()) KS  KI) )))   )(()((  K(KI())S  ('
